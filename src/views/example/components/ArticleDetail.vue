              ...
              <el-row>
                ...
                <el-col :span="10">
                  <el-form-item label-width="120px"
                                label="Publish Time:"
                                class="postInfo-container-item">
                    <el-date-picker v-model="displayTime"
                                    type="datetime"
...
export default {
  ...
  methods: {
    fetchData(id) {
      this.postForm = this.problem.filter(x => { return x.id == parseInt(id) })[0]
      // set tagsview title
    ...
    submitForm() {
      ...
      this.$refs.postForm.validate(valid => {
        if (valid) {
          ...
          if (!this.isEdit) {
            this.postForm.id = this.problem.length + 1
            this.problem.push(this.postForm)
          }
          this.loading = false
        } else {
